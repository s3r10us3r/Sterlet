...
namespace Chess
{
    ...
    public partial class PlayerVsPLayerPopupContents : UserControl
    {
        ...
        {
            MainWindowSingleton.mainWindow.ChangePage(new Game(Logic.Board.STARTING_POSITION, PlayerType.HUMAN_PLAYER, PlayerType.HUMAN_PLAYER, optionsList[timeIndex]));
        }
    }
}
